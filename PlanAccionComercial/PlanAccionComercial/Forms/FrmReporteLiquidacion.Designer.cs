...
{
	partial class FrmReporteLiquidacion
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FrmReporteLiquidacion));
			...
			this.col_porc_proveedor = new System.Windows.Forms.DataGridViewTextBoxColumn();
			this.col_por_mega = new System.Windows.Forms.DataGridViewTextBoxColumn();
			...
			this.col_liquidado = new System.Windows.Forms.DataGridViewButtonColumn();
			...
			this.btn_exportar.Location = new System.Drawing.Point(824, 635);
			...
			this.dgv_detalle.Size = new System.Drawing.Size(1010, 310);
			...
			this.col_descuento.DefaultCellStyle = dataGridViewCellStyle1;
			...
			this.col_porc_proveedor.DefaultCellStyle = dataGridViewCellStyle2;
			this.col_porc_proveedor.HeaderText = "Asume proveedor";
			this.col_porc_proveedor.Name = "col_porc_proveedor";
			this.col_porc_proveedor.ReadOnly = true;
			// 
			// col_por_mega
			// 
			...
			this.col_por_mega.DefaultCellStyle = dataGridViewCellStyle3;
			this.col_por_mega.HeaderText = "Asume Megatiendas";
			this.col_por_mega.Name = "col_por_mega";
			this.col_por_mega.ReadOnly = true;
			// 
			// col_mod_cobro
			// 
			...
			this.col_obs.DefaultCellStyle = dataGridViewCellStyle4;
			...
			this.btnCerrar.Location = new System.Drawing.Point(924, 635);
			...
			this.cmb_dinamicas.Size = new System.Drawing.Size(233, 21);
			...
			this.pnl_cab.Size = new System.Drawing.Size(1014, 41);
			...
			this.label3.Text = "Reporte liquidación";
			// 
			// pictureBox1
			// 
			...
			this.dgv_reporte.Size = new System.Drawing.Size(1010, 187);
			...
			this.col_retroplanning.DefaultCellStyle = dataGridViewCellStyle5;
			...
			this.col_consecutivo.DefaultCellStyle = dataGridViewCellStyle6;
			...
			// col_liquidado
			// 
			this.col_liquidado.HeaderText = "";
			this.col_liquidado.Name = "col_liquidado";
			this.col_liquidado.ReadOnly = true;
			this.col_liquidado.Text = "Liquidar";
			this.col_liquidado.UseColumnTextForButtonValue = true;
			this.col_liquidado.Width = 60;
			// 
			// label8
			// 
			...
			this.btn_buscar.Location = new System.Drawing.Point(922, 79);
			...
			this.cmb_proveedores.DropDownWidth = 280;
			this.cmb_proveedores.FormattingEnabled = true;
			this.cmb_proveedores.Location = new System.Drawing.Point(463, 86);
			this.cmb_proveedores.Name = "cmb_proveedores";
			this.cmb_proveedores.Size = new System.Drawing.Size(233, 21);
			this.cmb_proveedores.TabIndex = 8;
			// 
			// label1
			// 
			...
			this.chk_retro.Location = new System.Drawing.Point(707, 77);
			this.chk_retro.Name = "chk_retro";
			this.chk_retro.Size = new System.Drawing.Size(101, 17);
			this.chk_retro.TabIndex = 10;
			...
			this.label2.Location = new System.Drawing.Point(704, 58);
			this.label2.Name = "label2";
			this.label2.Size = new System.Drawing.Size(125, 13);
			this.label2.TabIndex = 9;
			this.label2.Text = "Buscar consecutivo de: ";
			// 
			// txt_filtrar
			// 
			...
			this.Name = "FrmReporteLiquidacion";
			this.Text = "Reporte liquidación";
			this.Load += new System.EventHandler(this.FrmReporteLiquidacion_Load);
		...
		private System.Windows.Forms.DataGridViewButtonColumn col_liquidado;
		...
		private System.Windows.Forms.DataGridViewTextBoxColumn col_porc_proveedor;
		private System.Windows.Forms.DataGridViewTextBoxColumn col_por_mega;
