namespace PlanAccionComercial.Forms
{
    partial class FrmClusters
    {
        ...
        {
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FrmClusters));
			...
			this.col_ppal = new System.Windows.Forms.DataGridViewCheckBoxColumn();
			...
			this.pnl_cab.Size = new System.Drawing.Size(537, 41);
			...
			// txt_cod
			// 
			this.txt_cod.Location = new System.Drawing.Point(88, 63);
			...
			// txt_desc
			// 
			this.txt_desc.Location = new System.Drawing.Point(88, 93);
			...
			this.clb_co.Location = new System.Drawing.Point(12, 147);
			...
			this.btnGuardar.Location = new System.Drawing.Point(301, 262);
			...
			// dgv_clusters
			// 
			this.dgv_clusters.AllowUserToAddRows = false;
			this.dgv_clusters.AllowUserToDeleteRows = false;
			this.dgv_clusters.Anchor = ((System.Windows.Forms.AnchorStyles)((((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom) 
            | System.Windows.Forms.AnchorStyles.Left) 
            | System.Windows.Forms.AnchorStyles.Right)));
			this.dgv_clusters.BackgroundColor = System.Drawing.SystemColors.Window;
			this.dgv_clusters.ColumnHeadersHeightSizeMode = System.Windows.Forms.DataGridViewColumnHeadersHeightSizeMode.AutoSize;
			this.dgv_clusters.Columns.AddRange(new System.Windows.Forms.DataGridViewColumn[] {
            this.col_cod,
            this.col_desc,
            this.col_ppal,
            this.col_activo,
            this.col_editar,
            this.col_eliminar});
			this.dgv_clusters.Location = new System.Drawing.Point(12, 300);
			this.dgv_clusters.Name = "dgv_clusters";
			this.dgv_clusters.ReadOnly = true;
			this.dgv_clusters.SelectionMode = System.Windows.Forms.DataGridViewSelectionMode.FullRowSelect;
			this.dgv_clusters.Size = new System.Drawing.Size(534, 220);
			this.dgv_clusters.TabIndex = 9;
			this.dgv_clusters.CellContentClick += new System.Windows.Forms.DataGridViewCellEventHandler(this.dgv_clusters_CellContentClick);
			this.dgv_clusters.RowPostPaint += new System.Windows.Forms.DataGridViewRowPostPaintEventHandler(this.dgv_clusters_RowPostPaint);
			// 
			// btnCerrar
			// 
			...
			this.btnCerrar.Location = new System.Drawing.Point(451, 526);
			...
			this.chk_activo.Location = new System.Drawing.Point(88, 259);
			this.chk_activo.Name = "chk_activo";
			this.chk_activo.Size = new System.Drawing.Size(57, 17);
			this.chk_activo.TabIndex = 7;
			...
			this.chk_ppal.Location = new System.Drawing.Point(12, 259);
			this.chk_ppal.Name = "chk_ppal";
			this.chk_ppal.Size = new System.Drawing.Size(70, 17);
			this.chk_ppal.TabIndex = 11;
			...
			// col_ppal
			// 
			this.col_ppal.HeaderText = "Principal";
			this.col_ppal.Name = "col_ppal";
			this.col_ppal.ReadOnly = true;
			this.col_ppal.Width = 60;
			// 
			// col_activo
			// 
			...
			this.col_activo.Resizable = System.Windows.Forms.DataGridViewTriState.True;
			this.col_activo.SortMode = System.Windows.Forms.DataGridViewColumnSortMode.Automatic;
			...
			this.Controls.Add(this.dgv_clusters);
			...
			this.Name = "FrmClusters";
			this.Text = "Clusters";
			this.Load += new System.EventHandler(this.FrmClusters_Load);
		...
		private System.Windows.Forms.DataGridViewCheckBoxColumn col_ppal;
